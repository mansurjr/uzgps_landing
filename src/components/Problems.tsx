    ...
    <section ref={root} aria-labelledby="problems-title" className="bg-white py-24 lg:py-36">
      <div className="wrap">
        ...
        <div className="mt-16 border-t-2 border-ink">
          <ul>
            {t.content.problems.map((p) => (
              <li key={p.q} data-reveal className="group relative grid gap-3 border-b border-rule py-7 md:grid-cols-2 md:gap-10 md:py-8">
                ...
                <p className="font-display text-[clamp(20px,1.9vw,26px)] font-medium leading-snug tracking-[-0.02em]">{p.q}</p>
