...
export const uz: Dict = {
  ...
  nav: {
    ...
    megaServer: { title: "Server yechimi", text: "SMPO sizning infratuzilmangizda, 500 dan 10 000 ta mashinagacha." },
  ...
  hero: {
    ...
    figures: [
      { label: "yildan beri O‘zbekiston bozorida" },
  ...
  clients: {
    ...
    lead: "O‘zbekiston bo‘ylab davlat xizmatlari, banklar, sanoat va biznes. Batafsil ma’lumot uchun logotipni bosing.",
  },
  ...
  solutions: {
    ...
    deploy: [
      ...
      { k: "Ko‘lami", cloud: "Bitta mashinadan boshlab", server: "500 dan 10 000 ta mashinagacha" },
      {
  ...
  equipment: {
    ...
    carousel: {
      title: "Teltonika trekerlari",
      lead: "12 oy kafolatli original uskuna. Transportingiz va vazifalaringizga mos modelni tanlab beramiz.",
      prev: "Oldingi treker",
      next: "Keyingi treker",
      tablist: "Treker modellari",
      slideOf: "{n} tadan {i}: {model}",
      cta: "Park uchun treker tanlash",
    },
  },
  ...
  content: {
    ...
    clientIndustries: {
      ...
      "c-cbu": "Davlat sektori",
      "c-ung": "Neft-gaz sohasi",
      "c-uty": "Temir yo‘l transporti",
      "c-guvd": "Huquqni muhofaza qilish organlari",
      "c-uzex": "Moliya sektori",
      "c-uzagro": "Qishloq xo‘jaligi",
      "c-tshtx": "Yo‘lovchi transporti",
      "c-safia": "Oziq-ovqat sanoati",
      "c-zenta": "Farmatsevtika",
      "c-eurasia": "Xalqaro logistika",
      "c-garant": "Ishlab chiqarish va riteyl",
      "c-tml": "Yuk tashish",
      "c-oriat": "Media va korporatsiyalar",
      "c-yellow": "Axborot xizmatlari",
    },
    featured: {
